...
<header>
    ...
    <div class="container">
        ...
        <main>
        <div>
                <form action="/LearnEd_E-learning_Website-master/backend/tefulldetail.php" class="form" method="post">
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" name="qualification" placeholder="Enter qualification detail " required />
                    </div>                    
