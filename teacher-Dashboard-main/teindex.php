...
$sql = "SELECT * FROM `te full detail`" ;
...
<body>
    ...
    <div class="container">
        ...
        <!--<div>
            ...
            <br>
            <div class="class">
              <a href="/LearnEd_E-learning_Website-master/videocall/sender/sender.html">
                <button>To start the class</button>
              </a>
            </div>
        </main>
